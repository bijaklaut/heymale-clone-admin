...
export const CardSvg = (props: { className?: string }) => {
  const { className } = props;
  return (
    <svg
      className={className}
...
export const ImageSvg = (props: { className?: string }) => {
  const { className } = props;
  return (
    <svg
      className={className}
...
export const KeySvg = (props: { className?: string }) => {
  const { className } = props;
  return (
    <svg
      className={className}
...
export const ArrowDownSvg = (props: { className?: string }) => {
  const { className } = props;
  return (
    <svg
      className={className}
...
export const NoteSvg = (props: { className?: string }) => {
  const { className } = props;
  return (
    <svg
      className={className}
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g id="Page-1" strokeWidth="1" fillRule="evenodd">
          <g id="Icon-Set" transform="translate(-308.000000, -99.000000)">
            <path
...
export const CircleCheckSvg = (props: { className?: string }) => {
  const { className } = props;
  return (
    <svg
      className={className}
...
export const OptionDotSvg = (props: { className?: string }) => {
  const { className } = props;
  return (
    <svg
      className={className}
...
export const InfoSvg = (props: { className?: string }) => {
  const { className } = props;
  return (
    <svg
      className={className}
...
export const TruckSvg = (props: { className?: string }) => {
  const { className } = props;
  return (
    <svg
      className={className}
...
export const ClockSvg = (props: { className?: string }) => {
  const { className } = props;
  return (
    <svg
      className={className}
...
export const CopySvg = (props: { className?: string }) => {
  const { className } = props;
  return (
    <svg
      className={className}
...
export const LongArrowLeft = (props: { className?: string }) => {
  const { className } = props;
  return (
    <svg
      className={className}
