...
const CategoryDisplay = ({ category, deselect }: ThisProps) => {
  return (
    <div className="relative flex w-full items-center justify-center gap-x-3 rounded-md bg-white px-3 py-2 shadow-lg">
